...
namespace EasyJob_ProDG.Data.Info_data
{
    public partial class CodesDictionary
    {
        ...
        public static Dictionary<string, string> ConflictCodes = new Dictionary<string, string>
        {
            ...
            { "EXPLNIL", "Compatibility group is not provided, therefore it was not taken into account for segregation purpose. \nTwo goods of class 1 are potentially conflicting in mixed stowage. Goods of class 1 shall be stowed in separate compartments or holds, or closed cargo transport units. Closed cargo transport unit shall be “separated from” one another (7.2.7)." },
            {"EXPL0", "Mixed stowage is not permitted according to Table 7.2.7.1.4. Goods of class 1 shall be stowed in separate compartments or holds, or closed cargo transport units. Closed cargo transport unit shall be “separated from” one another (7.2.7)." },
