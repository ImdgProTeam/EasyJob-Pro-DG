...
namespace EasyJob_ProDG.UI.ViewModel
{
    public class DataGridDgContextMenuViewModel : Observable
    {
        ...
        const string PSN_MOLTEN = "MOLTEN";
        const string PSN_EMPTY_UNCLEANED = "EMPTY UNCLEANED";
        const string PSN_RESIDUE = "RESIDUE LAST CONTAINED";
        ...
        public string HeaderTitleMOLTEN => PSN_MOLTEN;
        public string HeaderTitleEMPTY_UNCLEANED => PSN_EMPTY_UNCLEANED;
        public string HeaderTitleRESIDUE => PSN_RESIDUE;
        ...
        public bool IsToNameIncludedMolten => SelectedDg?.Name.Contains(PSN_MOLTEN) ?? false;
        public bool IsToNameIncludedEmptyUncleaned => SelectedDg?.Name.Contains(PSN_EMPTY_UNCLEANED) ?? false;
        public bool IsToNameIncludedResidue => SelectedDg?.Name.Contains(PSN_RESIDUE) ?? false;
        ...
        internal void AppendProperShippingName(object obj)
        {
            ...
            switch ((string)obj)
            {
                ...
                case PSN_STABILIZED:
                    ...
                    break;
                case PSN_MOLTEN:
                    isIncluded = IsToNameIncludedMolten;
                    break;
                case PSN_EMPTY_UNCLEANED:
                    isIncluded = IsToNameIncludedEmptyUncleaned;
                    break;
                case PSN_RESIDUE:
                    isIncluded = IsToNameIncludedResidue;
                    break;
                case PSN_COOLANT:
