...
namespace EasyJob_Pro_DG
{
    partial class Stowage
    {
        ...
        /// <returns></returns>
        public static bool SpecialStowageCheck(string sscode, Dg dg, ObservableCollection<Container> containers, ShipProfile ship)
        {
            ...
            switch (sscode)
            {
                ...
                case "SW2":
                    ...
                    break;
                case "SW3":
                    if (!dg.RF) result = true;
                    break;
                case "SW4":
                    result = true;
                    break;
                case "SW5":
                    if(dg.underdeck) SWgroups.AddSW5 = dg;
                    break;
                case "SW6":
                    result = (dg.underdeck && ship.doc.DOCtable[dg.holdNr, 6] == 0);
                    if (dg.underdeck) SWgroups.AddSW6 = dg;
                    break;
                case "SW7":
                    result = true;
                    break;
                ...
                case "SW10":
                    ...
                    break;
                case "SW11":
                    if (!dg.underdeck) result = !CheckProtectedUnit(dg, containers, ship.row00exists);
                    break;
                case "SW12":
                    result = true;
                    break;
                ...
                case "SW15":
                    ...
                    break;
                case "SW16":
                    if (dg.closed == false) { dg.stowageCat = 'B'; result = true; }
                    break;
                case "SW17":
                    result = dg.underdeck;
                    if (dg.closed) { dg.stowageCat = 'E'; result = true; }
                    break;
                case "SW18":
                    result = dg.underdeck;
                    break;
                ...
                case "SW22":
                    ...
                    if (dg.underdeck || ship.IsInLivingQuarters(dg))
                        SWgroups.AddSW22 = dg;
                    break;
                case "SW23":
